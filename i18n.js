...
const I18N = {
  it: {
    ...
    home: {
      ...
      navRicetteDesc: "Oltre 1500 piatti facili, con filtri per pesce, stile e tempo di preparazione",
    ...
    ricette: {
      ...
      subtitle: "Oltre 1500 piatti facili per la vita da Erasmus, tra carne, pesce e opzioni vegetariane",
  ...
  en: {
    ...
    home: {
      ...
      navRicetteDesc: "Over 1500 easy dishes, with filters for fish, style and prep time",
    ...
    ricette: {
      ...
      subtitle: "Over 1500 easy dishes for Erasmus life, with meat, fish and vegetarian options",
    ...
    guida: {
      ...
      sectionRicetteText: "Over 1500 recipes filterable by category, style (light, balanced, indulgent), prep time, whether they contain fish, and allergens to exclude. Save your favourites with the star, turn on \"In a rush\" mode to see only quick recipes with few ingredients, or type what's in your fridge to find recipes using what you already have.",
  ...
  es: {
    ...
    home: {
      ...
      navRicetteDesc: "Más de 1500 platos fáciles, con filtros de pescado, estilo y tiempo de preparación",
    ...
    ricette: {
      ...
      subtitle: "Más de 1500 platos fáciles para la vida Erasmus, entre carne, pescado y opciones vegetarianas",
